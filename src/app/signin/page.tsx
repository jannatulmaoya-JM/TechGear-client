  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-5 px-4 bg-gray-50/50">
      <div className="max-w-sm w-full bg-white p-6 rounded-2xl shadow-xl border border-gray-100">
        <h2 className="text-2xl font-extrabold text-center mb-1 text-gray-900">Login</h2>
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <button 
            type="submit" 
            disabled={loading} 
            className="w-full py-3 text-white font-medium rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 hover:bg-blue-700 transition"
          >
        ...
        <button 
          ...
          className="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-gray-200 rounded-xl hover:bg-gray-50 text-sm text-black font-medium cursor-pointer"
        >
        ...
        <p className="text-sm text-gray-600 text-center mt-6">
          Don't have an account? <NextLink href="/signup" className="text-blue-600 font-semibold hover:underline">Register here</NextLink>
        </p>
      </div>
    </div>
  );
